...
function ft_next_booking_form_products_shortcode($atts) {
    ...
    if (!$styles_printed) {
        ...
        <style id="ft-bfp-styles">
            ...
            .ft-bf { display: block; width: 100% !important; max-width: 100% !important; margin-inline: 0 !important; padding: clamp(20px, 5vw, 36px); overflow: visible; border: 1px solid rgba(255,255,255,.5); border-radius: 20px; background: #fff; box-shadow: 0 25px 50px -12px rgba(0,0,0,.25); color: #0f172a; font-family: inherit; font-size: 14px; }
                ...
                <div class="ft-bf__columns" style="margin-top:20px">
                    <label class="ft-bf__field">
                        ...
                        <div class="ft-bf__cselect" data-name="startTime">
                            ...
                            <div class="ft-bf__cselect-menu" hidden role="listbox">
                                <?php foreach ($start_times as $i => $st) : ?>
                                    <button type="button" class="ft-bf__cselect-option<?php echo $i === 0 ? ' is-selected' : ''; ?>" data-value="<?php echo esc_attr($st); ?>" role="option"><?php echo esc_html($st); ?></button>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </label>
                    <label class="ft-bf__field">
                        ...
                        <div class="ft-bf__cselect" data-name="preferredVisitTime">
                            ...
                            <span class="ft-bf__cselect-arrow" aria-hidden="true"></span>
                            <div class="ft-bf__cselect-menu" hidden role="listbox">
                                <?php foreach ($visit_times as $i => $vt) : ?>
                                    <button type="button" class="ft-bf__cselect-option<?php echo $i === 0 ? ' is-selected' : ''; ?>" data-value="<?php echo esc_attr($vt); ?>" role="option"><?php echo esc_html($vt); ?></button>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </label>
