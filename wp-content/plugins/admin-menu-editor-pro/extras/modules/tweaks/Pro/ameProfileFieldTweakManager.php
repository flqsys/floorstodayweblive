...
use YahnisElsts\AdminMenuEditor\Tweaks\Core\ameHideJquerySelectorTweak;
use YahnisElsts\AdminMenuEditor\Tweaks\Core\ameHideSelectorTweak;
	...
	public function maybeEnqueueDetectorScript($hook = '') {
		...
		if (
			...
			$script = ScriptDependency::create(
				plugins_url('profile-field-detector.js', dirname(__FILE__)),
