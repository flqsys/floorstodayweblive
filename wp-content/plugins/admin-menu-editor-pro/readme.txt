...
##### Changed
* Access to the "Tweaks" tab now requires the `edit_theme_options` capability, in addition to other AME permissions. This shouldn't affect most users since administrators normally have this capability by default.
...
* Fixed the `[ame-count-bubble]` shortcode not displaying the "WooCommerce -> Orders" bubble from WooCommerce 10.6.0.
