...
add_action( 'wp_ajax_lrgawidget_getRealTime', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
add_action( 'wp_ajax_lrgawidget_getCountries', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
add_action( 'wp_ajax_lrgawidget_getKeywords', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
add_action( 'wp_ajax_lrgawidget_getSources', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
add_action( 'wp_ajax_lrgawidget_setGraphData', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
add_action( 'wp_ajax_lrgawidget_setPermissions', 'Lara\Widgets\GoogleAnalytics\lrgawidget_callback' );
...
function lrgawidget_enqueue($hook) {
	if ( ('index.php' === $hook) && !is_network_admin() ){
		...
		if (!empty(DataStore::$RUNTIME["permissions"])){
