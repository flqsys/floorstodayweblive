...
class Hotspot extends Widget_Image {
	...
	protected function render() {
		...
		foreach ( $settings['hotspot'] as $key => $hotspot ) :
			...
			$_hoff_x = array_key_exists( 'hotspot_offset_x', $hotspot ) ? $hotspot['hotspot_offset_x'] : null;
			$hotspot_position_x = is_array( $_hoff_x ) && '%' === ( $_hoff_x['unit'] ?? '' ) ? 'e-hotspot--position-' . $hotspot['hotspot_horizontal'] : '';
			$_hoff_y = array_key_exists( 'hotspot_offset_y', $hotspot ) ? $hotspot['hotspot_offset_y'] : null;
			$hotspot_position_y = is_array( $_hoff_y ) && '%' === ( $_hoff_y['unit'] ?? '' ) ? 'e-hotspot--position-' . $hotspot['hotspot_vertical'] : '';
